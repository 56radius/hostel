...
<tr>
<td><b> regNo : </b><?php echo $row->regNo;?></td>
<td><b> FirstName : </b><?php echo $row->firstName;?></td>
<td><b>  MiddleName : </b><?php echo $row->middleName;?></td>
<td><b> LastName : </b><?php echo $row->lastName;?></td>
<td><b> Gender : </b><?php echo $row->gender;?></td>
<td><b> Email : </b><?php echo $row->email;?></td>
<td><b> Room No: </b> <?php echo $row->room_no;?></td>
</tr>
