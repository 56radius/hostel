								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											...
											<a href="manage-hostel.php" class="block-anchor panel-footer text-center">See All &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
...
<p> Powered By <a href="#" target="_blank"> Avinx Nation </p>
</footer> </div>
...
<!-- By AVINX NATION.... association with CodeNi-->